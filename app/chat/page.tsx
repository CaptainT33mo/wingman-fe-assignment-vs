...
const ChatMessage = ({
  ...
  <div className={`flex ${isBot ? "justify-start" : "justify-end"} mb-4`}>
    <div
      ...
      ${isBot ? "bg-mutedGreen text-brand" : "bg-brand text-white"}
    `}
    >
      {message}
    </div>
      ...
      <div className="w-full min-h-[500px] max-h-[650px] h-full overflow-y-auto rounded-lg border border-gray-200 flex flex-col bg-white shadow-lg">
        ...
        <form onSubmit={handleSend} className="p-4 border-t border-gray-200">
          <div className="flex space-x-2">
            ...
            <Button
              type="submit"
              className="p-2 px-4 items-center justify-center bg-brand text-white rounded-lg hover:bg-[#0a4740] focus:outline-none focus:ring-2 focus:ring-[#115E56]"
            >
