  ...
  return (
    <>
      <div className="grid grid-cols-12 gap-6">
        <div className="col-span-12 lg:col-span-7 bg-white py-6 rounded-3xl border-[0.5px] drop-shadow-sm px-2">
          <div className="flex items-center gap-2 mb-6 px-6">
            <PiChatTeardropFill size={14} className="text-disabledText" />
        ...
        <div className="col-span-12 lg:col-span-3 bg-white py-8 rounded-3xl border-[0.5px] drop-shadow-sm">
          <div className="flex items-center gap-2 mb-6 px-6">
            <BsBarChartFill size={14} className="text-disabledText" />
            ...
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <Bar
                  ...
                  barSize={30}
                  radius={[5, 5, 0, 0]}
                  activeBar={<Rectangle fill="#CCFBEF" />}
                />
                <Bar
                  dataKey="orders"
                  fill="#115E59"
                  barSize={30}
                  radius={[5, 5, 0, 0]}
                  activeBar={<Rectangle fill="#115E59" />}
                />
              </BarChart>
            </ResponsiveContainer>
          </div>
