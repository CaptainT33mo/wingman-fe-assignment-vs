...
export default function Forecast() {
  return (
    <div className="col-span-12 lg:col-span-2 relative overflow-hidden bg-[#15B79E] bg-gradient-to-br from-[#15B79E] to-[#086f61] p-6 rounded-3xl text-white z-10">
      <div className="flex items-center gap-2 mb-6">
        <PiChatTeardropFill size={14} />
        <p className="text-sm text-mutedGreen uppercase tracking-wider">
          FORECASTS
        </p>
      </div>
      ...
      <div className="absolute -top-16 -left-16 w-[180px] h-[180px] rounded-full bg-[#e1fffa0c] -z-[1]"></div>
      <div className="absolute -top-36 -left-36 w-[350px] h-[350px] rounded-full bg-[#c3eee81a] -z-[1]"></div>
      <div className="absolute -top-64 -left-64 w-[560px] h-[560px] rounded-full bg-[#9ad6cd15] -z-[1]"></div>
    </div>
  );
}
